      ...
      >
        <Header style={customStyles.main}>
          ...
          <Body>
            ...
            <Subtitle style={customStyles.text}>Version 2.1</Subtitle>
          </Body>
          <Right>
            <Switch value={defaultLanguage} onValueChange={this.handleToggle} />
            <Icon
              name='flag-checkered'
              type='FontAwesome'
              style={{ color: 'white' }}
            ...
            >
              ...
              <Col size={1}>
                <H1 style={customStyles.italic}>
                  {defaultLanguage ? language.spanish.vs : language.english.vs}
                </H1>
              </Col>
              <Col size={1} />
            </Row>
        ...
        <Footer style={customStyles.dark}>
          <Subtitle
            style={{
              paddingTop: 10,
            }}
